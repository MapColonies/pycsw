            ...
            typename: TypenameModel(
                added_namespaces[prefix],
                {
                    'MCRasterQueryables': {
                        ...
                        'mc:imagingTime_beginUTC': Queryable(context.md_core_model['mappings']['pycsw:TempExtent_begin'], 'mc:imagingTime_beginUTC'),
                        'mc:imagingTime_endUTC': Queryable(context.md_core_model['mappings']['pycsw:TempExtent_end'], 'mc:imagingTime_endUTC'),
                        'mc:maxResolutionDeg': Queryable(context.md_core_model['mappings']['pycsw:Resolution'], 'mc:maxResolutionDeg'),
                        'mc:maxResolutionMeter': Queryable(context.md_core_model['mappings']['pycsw:Resolution'], 'mc:maxResolutionDeg'),
                        'mc:MinHorizontalAccuracyCE90': Queryable(context.md_core_model['mappings']['pycsw:maxResolutionMeter'], 'mc:maxResolutionMeter'),
