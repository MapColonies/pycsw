            ...
            typename: TypenameModel(
                added_namespaces[prefix],
                {
                    'MGCGQueryables': {
                        ...
                        'mcgc:region': Queryable('region', 'mc:region'),
                        'mcgc:sensorName': Queryable('sensor_name', 'mc:sensor/name'),
                        'mcgc:sensorType': Queryable('sensor_type', 'mc:sensor/type'),
                        'mcgc:version': Queryable('version', 'mc:version')
                    }
                })
        }

        super().__init__(name='mcgc_base',
                         version='1.0.0',
